      ...
      function (e, t, s) {
        ...
        var c = "",
          ...
          f = {
            ...
            onBan: function (e, t) {
              f.isDebug && console.log("onBan default handler");
            },
            onTimeout: function (e, t, s) {
              f.isDebug && console.log("onTimeout default handler");
            },
            ...
            onResub: function (e, t, s, n, o, i) {
              f.isDebug && console.log("onResub default handler");
            },
            onSubGift: function (e, t, s, n, o, i) {
              f.isDebug && console.log("onSubGift default handler");
            },
            onSubMysteryGift: function (e, t, s, n, o) {
            ...
            Init: function (e, t, s, u) {
              if (
                (("string" == typeof (s = s || [e]) || s instanceof String) &&
                  (s = [s]),
                !Array.isArray(s))
              )
              ...
              var p = {
                options: { debug: u },
                connection: { reconnect: !0, secure: !0 },
                channels: s,
              };
              t && ((p.identity = { username: e, password: t }), (l = t)),
                (h = new n.client(p)).on("roomstate", function (e, t) {
                  try {
                    var s = e.replace("#", "");
                    (f.chatModes[s] = f.chatModes[s] || {}),
                      "emote-only" in t &&
                        (f.chatModes[s].emoteOnly = t["emote-only"]),
                      "followers-only" in t &&
                        (f.chatModes[s].followerOnly =
                          t["followers-only"] >= 0),
                      "subs-only" in t &&
                        (f.chatModes[s].subOnly = t["subs-only"]),
                ...
                h.on("message", function (t, s, n, o) {
                  try {
                    var i = s["display-name"] || s.username || e,
                      a = "#" + s.username === t,
                      c = s.mod,
                      l = s.badges && "0" === s.badges.founder,
                      u =
                        l ||
                        (s.badges && void 0 !== s.badges.subscriber) ||
                        s.subscriber,
                    ...
                    if (o || "!" !== n[0])
                      "action" === k || "chat" === k
                        ? f.onChat(i, n, x, o, E)
                        : "whisper" === k && f.onWhisper(i, n, x, o, E);
                    else {
                      var T = n.split(/ (.*)/),
                        I = T[0].slice(1).toLowerCase(),
                        D = T[1] || "";
                      (E.sinceLastCommand = (function (e, t) {
                        if (!e) return { any: null, user: null };
                        var s = new Date(),
                          n = {};
                        return (
                          r.global[e] ? (n.any = s - r.global[e]) : (n.any = 0),
                          (r.global[e] = s),
                          t
                            ? (r.users[t] || (r.users[t] = {}),
                              r.users[t][e]
                                ? (n.user = s - r.users[t][e])
                                : (n.user = 0),
                              (r.users[t][e] = s))
                            : (n.user = null),
                          n
                ...
                h.on("messagedeleted", function (e, t, s, n) {
                  try {
                    ...
                    f.onMessageDeleted(o, i);
                  } catch (e) {
                    f.onError(e);
                  }
                }),
                h.on("ban", function (e, t, s, n) {
                  try {
                    var o = t,
                      i = {
                        roomId: n["room-id"],
                        username: t,
                        bannedUserId: n["target-user-id"],
                      };
                    f.onBan(o, i);
                  } catch (e) {
                    f.onError(e);
                ...
                h.on("timeout", function (e, t, s, n, o) {
                  try {
                    var i = t,
                      r = n,
                      a = {
                        roomId: o["room-id"],
                        username: t,
                        timedOutUserId: o["target-user-id"],
                      };
                    f.onTimeout(i, r, a);
                  } catch (e) {
                    f.onError(e);
                ...
                h.on("cheer", function (e, t, s) {
                  var n = ~~t.bits,
                    o = t["room-id"],
                    i = t["display-name"] || t.username || t.login,
                    r = t["user-id"],
                    a = "#" + t.username === e,
                    c = t.mod,
                    ...
                    u = {
                      ...
                      subscriber:
                        l ||
                        (t.badges && void 0 !== t.badges.subscriber) ||
                        t.subscriber,
                ...
                h.on("subscription", function (e, t, s, n, o) {
                  var i = {
                    id: o.id,
                    roomId: o["room-id"],
                ...
                h.on("resub", function (e, t, s, n, o, i) {
                  ...
                  f.onResub(t, n, s, r, i, a);
                }),
                h.on("subgift", function (e, t, s, n, o, i) {
                  var r = ~~i["msg-param-sender-count"],
                    a = {
                      ...
                      recipientDisplayName:
                        i["msg-param-recipient-display-name"],
                      recipientUsername: i["msg-param-recipient-user-name"],
                      recipientId: i["msg-param-recipient-id"],
                      channel: e.replace("#", ""),
                    };
                  f.onSubGift(t, s, n, r, o, a);
                }),
                h.on("submysterygift", function (e, t, s, n, o) {
                  var i = ~~o["msg-param-sender-count"],
                    r = {
                      ...
                      userState: o,
                      recipientDisplayName:
                        o["msg-param-recipient-display-name"],
                ...
                h.on("reconnect", function () {
                  console.log("Reconnecting"), d++, f.onReconnect(d);
                }),
                ...
                t &&
                  (async function e(t, s) {
                    let n;
                    s = s.replace("oauth:", "");
                    let r = await o("https://id.twitch.tv/oauth2/validate", {
                      headers: { Authorization: "OAuth " + s },
                    }).then((e) => e.json());
                    if (
                      !r.client_id ||
                      !r.scopes.includes("channel:read:redemptions") ||
                      !r.scopes.includes("user:read:email")
                    )
                    ...
                    let c,
                      l = (
                        await o(
                          "https://api.twitch.tv/helix/users?login=" + t,
                          {
                            headers: {
                    ...
                    (c =
                      "undefined" != typeof window
                        ? new WebSocket("wss://pubsub-edge.twitch.tv")
                        : new i("wss://pubsub-edge.twitch.tv")),
                      (c.onopen = function (e) {
                      ...
                      (c.onmessage = function (n) {
                        switch (
                          ((message = JSON.parse(n.data)), message.type)
                        ) {
                          case "RESPONSE":
                            "ERR_BADAUTH" === message.error &&
                              ...
                              if ("reward-redeemed" === e.type) {
                                ...
                                var o = t.reward,
                                  i = {
                                    ...
                                    prompt: o.prompt,
                                    cost: o.cost,
                                    userInputRequired: o.is_user_input_required,
                                    subOnly: o.is_sub_only,
                                    image: {
                                      url1x: o.image ? o.image.url_1x : null,
                                      url2x: o.image ? o.image.url_2x : null,
                                      url4x: o.image ? o.image.url_4x : null,
                                    },
                                    defaultImage: {
                                      url1x: o.default_image.url_1x,
                                      url2x: o.default_image.url_2x,
                                      url4x: o.default_image.url_4x,
                                    },
                                    ...
                                    maxPerStream: {
                                      enabled: o.max_per_stream.is_enabled,
                                      maxPerStream:
                                        o.max_per_stream.max_per_stream,
                                    },
                                    shouldRedemptionsSkipRequestQueue:
                                      o.should_redemptions_skip_request_queue,
                                    templateId: o.template_id,
                                    updatedForIndicatorAt:
                                      o.updated_for_indicator_at,
                                    maxPerUserPerStream: {
                                      enabled:
                                        o.max_per_user_per_stream.is_enabled,
                                      maxPerUserPerStream:
                                        o.max_per_user_per_stream
                                          .max_per_user_per_stream,
                                    },
                                    globalCooldown: {
                                      enabled: o.global_cooldown.is_enabled,
                                    ...
                                    cooldownExpiresAt: o.cooldown_expires_at,
                                  },
                                  r = {
                                ...
                                f.onReward(
                                  t.user.display_name || t.user.login,
                                  t.reward.title,
                                  t.reward.cost,
                                  t.user_input || "",
                                  r
            ...
            GetChannelRewards: async function (e, t = !1) {
              if (l) {
                if (!u) {
                  let t = await o(
                    "https://api.twitch.tv/helix/users?login=" + c,
                    {
                      headers: { "Client-ID": e, Authorization: "Bearer " + l },
                    }
                  ).then((e) => e.json());
                  u = t.data[0];
                }
                return (
                  (
                    await o(
                      `https://api.twitch.tv/helix/channel_points/custom_rewards?broadcaster_id=${u.id}&only_manageable_rewards=${t}`,
                      {
                        headers: {
                          "Client-ID": e,
            ...
            UpdateChannelReward: async function (e, t, s) {
              if (l) {
                ...
                return (
                  await o(
                    `https://api.twitch.tv/helix/channel_points/custom_rewards?broadcaster_id=${u.id}&id=${t}`,
                    {
                      method: "PATCH",
                      headers: {
                        "Client-ID": e,
        ...
        void 0 !== t && t.exports && (t.exports = f),
          "undefined" != typeof window &&
            ((window.ComfyJS = f), (n = window.tmi));
      },
      { "node-fetch": 2, "tmi.js": 4, ws: 3 },
    ],
    2: [
      function (e, t, s) {
        (function (e) {
      ...
      function (e, t, s) {
        (function (t) {
          !(function t(s, n, o) {
            ...
            for (var r = "function" == typeof e && e, a = 0; a < o.length; a++)
              i(o[a]);
            return i;
          })(
            {
                ...
                function (e, t, s) {
                  ...
                  t.exports = function (e, t) {
                    ...
                    if (
                      ...
                      n(o.merge({ method: "GET", json: !0 }, e, { url: s }), t);
                    else if (o.isExtension()) {
                      e = o.merge({ url: s, method: "GET", headers: {} }, e);
                      var i = new XMLHttpRequest();
                      for (var r in (i.open(e.method, e.url, !0), e.headers))
                        i.setRequestHeader(r, e.headers[r]);
                      (i.responseType = "json"),
                        i.addEventListener("load", function (e) {
                          4 == i.readyState &&
                            (200 != i.status
                              ? t(i.status, null, null)
                              : t(null, null, i.response));
                        }),
                        i.send();
                    } else {
                      var a =
                        "jsonp_callback_" + Math.round(1e5 * Math.random());
                      window[a] = function (e) {
                        delete window[a],
              ...
              3: [
                function (e, s, n) {
                  (function (t) {
                    ...
                    for (var d in (h.inherits(m, i), (m.prototype.api = n), o))
                      m.prototype[d] = o[d];
                    (m.prototype.handleMessage = function (e) {
                      ...
                      if (!h.isNull(e)) {
                        ...
                        var s = h.channel(h.get(e.params[0], null)),
                          ...
                          o = h.get(e.tags["msg-id"], null);
                        if (((e.tags = a.badges(a.emotes(e.tags))), e.tags))
                          for (var i in e.tags)
                            "emote-sets" !== i &&
                              "ban-duration" !== i &&
                              "bits" !== i &&
                              (h.isBoolean(e.tags[i])
                                ? (e.tags[i] = null)
                                : "1" === e.tags[i]
                                ? (e.tags[i] = !0)
                                : "0" === e.tags[i] && (e.tags[i] = !1));
                        if (h.isNull(e.prefix))
                          switch (e.command) {
                            case "PING":
                              this.emit("ping"),
                                h.isNull(this.ws) ||
                                  2 === this.ws.readyState ||
                                  3 === this.ws.readyState ||
                                  this.ws.send("PONG");
                              break;
                            case "PONG":
                              var r = new Date();
                              (this.currentLatency =
                                (r.getTime() - this.latency.getTime()) / 1e3),
                                this.emits(
                                  ["pong", "_promisePing"],
                                  [[this.currentLatency]]
                                ),
                          ...
                          switch (e.command) {
                            ...
                            case "NOTICE":
                              ...
                              switch (o) {
                                ...
                                case "r9k_on":
                                  this.log.info(
                                    "[" + s + "] This room is now in r9k mode."
                                  ),
                                    this.emits(
                                ...
                                case "unrecognized_cmd":
                                  this.log.info(w),
                                    this.emit("notice", s, o, n),
                                    "/w" === n.split(" ").splice(-1)[0] &&
                                      this.log.warn(
                                ...
                                case "host_off":
                                  break;
                                default:
                                  n.includes("Login unsuccessful") ||
                                  n.includes("Login authentication failed") ||
                                  n.includes("Error logging in") ||
                                  n.includes("Improperly formatted auth")
                                    ? ((this.wasCloseCalled = !1),
                                      (this.reconnect = !1),
                                      (this.reason = n),
                                      this.log.error(this.reason),
                                      this.ws.close())
                                    : n.includes("Invalid NICK")
                                    ? ((this.wasCloseCalled = !1),
                                      (this.reconnect = !1),
                            ...
                            case "USERNOTICE":
                              var S = e.tags["display-name"] || e.tags.login,
                                ...
                                E =
                                  h.unescapeIRC(
                                    h.get(e.tags["msg-param-sub-plan-name"], "")
                                  ) || null,
                                T = x.includes("Prime"),
                                I = e.tags,
                                D = ~~(e.tags["msg-param-streak-months"] || 0),
                                N =
                                  e.tags["msg-param-recipient-display-name"] ||
                                  e.tags["msg-param-recipient-user-name"],
                                P = ~~e.tags["msg-param-mass-gift-count"],
                                O = { prime: T, plan: x, planName: E };
                              switch (((I["message-type"] = o), o)) {
                                case "resub":
                                  this.emits(
                                ...
                                case "sub":
                                  ...
                                  break;
                                case "subgift":
                                  this.emit("subgift", s, S, D, N, O, I);
                                  break;
                                case "anonsubgift":
                                  this.emit("anonsubgift", s, D, N, O, I);
                                  break;
                                case "submysterygift":
                                  this.emit("submysterygift", s, S, P, O, I);
                                  break;
                                case "anonsubmysterygift":
                                  this.emit("anonsubmysterygift", s, P, O, I);
                                  break;
                                case "giftpaidupgrade":
                                  var R =
                                    e.tags["msg-param-sender-name"] ||
                                    e.tags["msg-param-sender-login"];
                                  this.emit("giftpaidupgrade", s, S, R, I);
                                  break;
                                ...
                                case "raid":
                                  S =
                                    e.tags["msg-param-displayName"] ||
                                    e.tags["msg-param-login"];
                            ...
                            case "CLEARCHAT":
                              if (e.params.length > 1) {
                                ...
                                this.log.info(
                                  "[" + s + "] Chat was cleared by a moderator."
                                ),
                                  this.emits(
                            ...
                            case "CLEARMSG":
                              if (e.params.length > 1) {
                                ...
                                ((I = e.tags)["message-type"] =
                                  ...
                                  this.emit("messagedeleted", s, S, U, I);
                              }
                              break;
                            case "RECONNECT":
                              this.log.info(
                              ...
                              (e.tags.username = this.username),
                                "mod" === e.tags["user-type"] &&
                                  (this.moderators[this.lastJoined] ||
                                    (this.moderators[this.lastJoined] = []),
                                  this.moderators[this.lastJoined].includes(
                                    this.username
                                  ) ||
                                    this.moderators[this.lastJoined].push(
                                      this.username
                                    )),
                                h.isJustinfan(this.getUsername()) ||
                                  this.userstate[s] ||
                            ...
                            case "ROOMSTATE":
                              if (
                                (h.channel(this.lastJoined) ===
                                  h.channel(e.params[0]) &&
                          ...
                          switch (e.command) {
                            case "MODE":
                              "+o" === n
                                ? (this.moderators[s] ||
                                    (this.moderators[s] = []),
                                  this.moderators[s].includes(e.params[2]) ||
                                    this.moderators[s].push(e.params[2]),
                                  this.emit("mod", s, e.params[2]))
                                : "-o" === n &&
                                  (this.moderators[s] ||
                                    (this.moderators[s] = []),
                          ...
                          switch (e.command) {
                            ...
                            case "PART":
                              ...
                              if (this.username === J)
                                (B = !0),
                                  ...
                                  -1 !== (G = this.channels.indexOf(s)) &&
                                    this.channels.splice(G, 1),
                                  -1 !== (G = this.opts.channels.indexOf(s)) &&
                                    this.opts.channels.splice(G, 1),
                            ...
                            case "WHISPER":
                              ...
                              this.log.info("[WHISPER] <" + J + ">: " + n),
                                e.tags.hasOwnProperty("username") ||
                                  (e.tags.username = J),
                            ...
                            case "PRIVMSG":
                              if (
                                ...
                                if (n.includes("hosting you for")) {
                                  ...
                                  n.includes("hosting you") &&
                                    this.emit("hosted", s, q, 0, W);
                              } else {
                                ...
                                F
                                  ...
                                  : e.tags.hasOwnProperty("bits")
                                  ? this.emit("cheer", s, e.tags, n)
                                  : ((e.tags["message-type"] = "chat"),
                                    this.log.info(
                                      "[" +
                                        s +
                                        "] <" +
                      ...
                      (m.prototype.connect = function () {
                        ...
                        return new Promise(function (t, s) {
                          (e.server = h.get(
                            ...
                            (e.reconnectTimer =
                              e.reconnectTimer * e.reconnectDecay),
                      ...
                      (m.prototype._onOpen = function () {
                        h.isNull(this.ws) ||
                          ...
                          (this.password = h.password(
                            h.get(this.opts.identity.password, "SCHMOOPIIE")
                          )),
                          ...
                          this.ws.send(
                            "USER " + this.username + " 8 * :" + this.username
                          ));
                      }),
                          ...
                          this.wasCloseCalled
                            ...
                            : (this.emits(
                              ...
                              this.reconnect &&
                                ...
                                (this.reconnections = this.reconnections + 1),
                                this.log.error(
                                  "Could not connect to server. Reconnecting in " +
                                    Math.round(this.reconnectTimer / 1e3) +
                                    " seconds.."
                                ),
                                this.emit("reconnect"),
                      ...
                      (m.prototype._sendCommand = function (e, t, s, n) {
                        ...
                        return new Promise(function (i, r) {
                          if (
                            ...
                            if (h.isNull(t))
                              o.log.info("Executing command: " + s),
                                o.ws.send(s);
                            else {
                              var a = h.channel(t);
                              o.log.info("[" + a + "] Executing command: " + s),
                                o.ws.send("PRIVMSG " + a + " :" + s);
                            }
                            n(i, r);
                          }
                        });
                      ...
                      (m.prototype._sendMessage = function (e, t, s, n) {
                        ...
                        return new Promise(function (i, r) {
                          if (
                            ...
                            2 === o.ws.readyState ||
                            3 === o.ws.readyState ||
                            h.isJustinfan(o.getUsername())
                          )
                            r("Not connected to server.");
                          else {
                            var c = h.channel(t);
                            if (
                              (o.userstate[c] || (o.userstate[c] = {}),
                              s.length >= 500)
                            ) {
                              var l = h.splitLine(s, 500);
                              (s = l[0]),
                                setTimeout(function () {
                                  o._sendMessage(e, t, l[1], function () {});
                                }, 350);
                            }
                            o.ws.send("PRIVMSG " + c + " :" + s);
                            var u = {};
                            Object.keys(o.emotesets).forEach(function (e) {
                              o.emotesets[e].forEach(function (e) {
                                return h.isRegex(e.code)
                                  ? a.emoteRegex(s, e.code, e.id, u)
                                  : void a.emoteString(s, e.code, e.id, u);
                              });
                            });
                            var m = h.merge(
                                o.userstate[c],
                          ...
                          this.api(
                            {
                              ...
                              headers: {
                                Authorization:
                                  ...
                                  h
                                    .password(
                                      h.get(this.opts.identity.password, "")
                                    )
                                    .replace("oauth:", ""),
                      ...
                      (m.prototype.disconnect = function () {
                        var e = this;
                        return new Promise(function (t, s) {
                          h.isNull(e.ws) || 3 === e.ws.readyState
                            ? (e.log.error(
                  ...
                  t.exports = {
                    ...
                    host: function (e, t) {
                      ...
                      return (
                        ...
                        this._sendCommand(
                          ...
                          "/host " + t,
                          function (n, o) {
                            s.once("_promiseHost", function (s, i) {
                              s ? o(s) : n([e, t, ~~i]);
                            });
                          }
                        )
                    ...
                    mods: function (e) {
                      ...
                      return (
                        ...
                        this._sendCommand(
                          ...
                          "/mods",
                          function (s, n) {
                            t.once("_promiseMods", function (o, i) {
                              o
                                ? n(o)
                                : (i.forEach(function (s) {
                                    t.moderators[e] || (t.moderators[e] = []),
                                      t.moderators[e].includes(s) ||
                                        t.moderators[e].push(s);
                                  }),
                                  s(i));
                            });
                          }
                    ...
                    timeout: function (e, t, s, n) {
                      ...
                      return (
                        (e = u.channel(e)),
                        (t = u.username(t)),
                        u.isNull(s) || u.isInteger(s) || ((n = s), (s = 300)),
                        (s = u.get(s, 300)),
                        (n = u.get(n, "")),
                        this._sendCommand(
                          this._getPromiseDelay(),
                          ...
                          "/timeout " + t + " " + s + " " + n,
                          function (i, r) {
                            o.once("_promiseTimeout", function (o) {
                              o ? r(o) : i([e, t, ~~s, n]);
                            });
                          }
                        )
                    ...
                    whisper: function (e, t) {
                      var s = this;
                      return (e = u.username(e)) === this.getUsername()
                        ? Promise.reject(
                ...
                function (e, t, s) {
                  ...
                  String.prototype.startsWith ||
                    ...
                    (n.prototype.removeListener = function (e, t) {
                      ...
                      if (
                        ((r = (s = this._events[e]).length),
                        (n = -1),
                        s === t || (o(s.listener) && s.listener === t))
                      ) {
                        if (
                          (delete this._events[e],
                          this._events.hasOwnProperty(e + "2") &&
                            "_" === e.charAt(0))
                        ) {
                          var c = e;
                          for (var l in this._events)
                            this._events.hasOwnProperty(l) &&
                              l.startsWith(c) &&
                              (isNaN(parseInt(l.substr(l.length - 1))) ||
                                ((this._events[
                                  e + parseInt(l.substr(l.length - 1) - 1)
                                ] = this._events[l]),
                    ...
                    (n.prototype.removeAllListeners = function (e) {
                      ...
                      if (o((s = this._events[e]))) this.removeListener(e, s);
                      else if (s)
                        for (; s.length; )
                  ...
                  t.exports = {
                    levenshtein: function (e, t, s) {
                      ...
                      var a,
                        ...
                        d = new Array(i + 1),
                        f = new Array(i + 1);
                      for (c = 0; i >= c; c++) d[c] = 1 * c;
                      for (a = 0; o > a; a++) {
                        for (f[0] = d[0] + 1, c = 0; i > c; c++)
                          (l = d[c] + (e[a] == t[c] ? 0 : 1)) >
                            (u = d[c + 1] + 1) && (l = u),
                            l > (h = f[c] + 1) && (l = h),
                            (f[c + 1] = l);
                    ...
                    raffle: {
                      ...
                      enter: function (e, t) {
                        this.init(e),
                          this.raffleChannels[n.channel(e)].push(
                            t.toLowerCase()
                          );
                      },
                      leave: function (e, t) {
                        this.init(e);
                        var s = this.raffleChannels[n.channel(e)].indexOf(
                          n.username(t)
                        );
                        return (
                          s >= 0 &&
                          (this.raffleChannels[n.channel(e)].splice(s, 1), !0)
                        );
                      },
                      pick: function (e) {
                        this.init(e);
                      ...
                      reset: function (e) {
                        this.init(e), (this.raffleChannels[n.channel(e)] = []);
                      },
                      count: function (e) {
                        return (
                          this.init(e),
                          this.raffleChannels[n.channel(e)]
                            ? this.raffleChannels[n.channel(e)].length
                            : 0
                        );
                      },
                      isParticipating: function (e, t) {
                        return (
                          this.init(e),
                          this.raffleChannels[n.channel(e)].includes(
                            n.username(t)
                          )
                        );
                      },
                ...
                function (e, t, s) {
                  ...
                  t.exports = {
                    badges: function (e) {
                      ...
                      return (
                        n.isBoolean(e.badges) && (e["badges-raw"] = null), e
                      );
                    },
                    emotes: function (e) {
                      if (n.isString(e.emotes)) {
                        for (
                          var t = e.emotes.split("/"), s = {}, o = 0;
                          o < t.length;
                          o++
                        ) {
                          var i = t[o].split(":");
                      ...
                      return (
                        n.isBoolean(e.emotes) && (e["emotes-raw"] = null), e
                      );
                    },
                    emoteRegex: function (e, t, s, o) {
                      for (
                        var i,
                          r = /\S+/g,
                          a = new RegExp(
                            "(\\b|^|s)" + n.unescapeHtml(t) + "(\\b|$|s)"
                          );
                        null !== (i = r.exec(e));
                        ...
                        a.test(i[0]) &&
                          ((o[s] = o[s] || []),
                          o[s].push([i.index, r.lastIndex - 1]));
                    },
                    emoteString: function (e, t, s, o) {
                      for (var i, r = /\S+/g; null !== (i = r.exec(e)); )
                        i[0] === n.unescapeHtml(t) &&
                          ((o[s] = o[s] || []),
                          o[s].push([i.index, r.lastIndex - 1]));
                    },
                    ...
                    msg: function (e) {
                      ...
                      if (-1 === (n = e.indexOf(" ", s)))
                        return e.length > s
                          ? ((t.command = e.slice(s)), t)
                          : null;
                      for (
                        t.command = e.slice(s, n), s = n + 1;
                        32 === e.charCodeAt(s);
                      ...
                      for (; s < e.length; ) {
                        ...
                        if (-1 === n) {
                          ...
                          for (
                            t.params.push(e.slice(s, n)), s = n + 1;
                            32 === e.charCodeAt(s);
                  ...
                  (function (e) {
                    ...
                    var s =
                      ...
                      a = (t.exports = {
                        ...
                        justinfan: function () {
                          return (
                            "justinfan" + Math.floor(8e4 * Math.random() + 1e3)
                          );
                        },
                        password: function (e) {
                          return ["SCHMOOPIIE", "", null].includes(e)
                            ? "SCHMOOPIIE"
                            : "oauth:" + e.toLowerCase().replace("oauth:", "");
                        },
                  ...
                  (m.nextTick = function (e) {
                    ...
                    if (arguments.length > 1)
                      for (var s = 1; s < arguments.length; s++)
                        t[s - 1] = arguments[s];
                    f.push(new c(e, t)), 1 !== f.length || p || i(a);
                  }),
